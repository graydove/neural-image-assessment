...
with tf.device('/CPU:0'):
    ...
    for img_path in img:
        ...
        # print('[result]:%.2f' % list(scores)[0])
        print('[result]:%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f' % (float(list(scores)[0]), float(list(scores)[1]), float(list(scores)[2]), float(list(scores)[3]), float(list(scores)[4]), float(list(scores)[5]), float(list(scores)[6]), float(list(scores)[7]), float(list(scores)[8]), float(list(scores)[9])))
