...
base_images_path = "/home/graydove/Datasets/AVA_dataset/images\\"
ava_dataset_path = "/home/graydove/Datasets/AVA_dataset/AVA.txt"
...
with open(ava_dataset_path) as f:
    lines = f.readlines()
...
val_image_paths = train_image_paths[-55000:]
val_scores = train_scores[-55000:]
train_image_paths = train_image_paths[:-55000]
train_scores = train_scores[:-55000]
